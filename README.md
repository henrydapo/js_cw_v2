...
1. Count logged in users, count users having greater than equal to 50 points from the following object. (hint: research on how to use loops)
...
2. Find people who are MERN stack developer from the users object
